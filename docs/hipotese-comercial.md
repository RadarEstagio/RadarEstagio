...
Preparado em 08/09/2026 para E05. Este documento organiza uma decisão futura; não implementa
checkout, cobrança, paywall ou preço e não muda o piloto gratuito. O benefício de referência é
o que a landing promete: até sete recomendações explicadas no Telegram, com candidatura feita
na fonte da vaga.

## Comparação

| Opção | Pagador hipotético | Benefício incluído | Duração | Previsibilidade | Relação com busca | Custo/margem |
|---|---|---|---|---|---|---|
...
| Campo | Estado |
|---|---|
| Oferta escolhida | decisão da equipe |
| Pagador e elegibilidade | decisão da equipe |
| Preço e moeda | decisão da equipe; não medido |
| Duração e renovação | decisão da equipe |
| Cancelamento e reembolso | decisão da equipe; revisar textos legais |
| Participantes atuais do piloto | decisão da equipe; preservar piloto gratuito até decidir |
| Forma de obter aceite | decisão da equipe |
| Provedor de cobrança | não escolhido; tarefa separada |

## Teste futuro, sem execução nesta sessão

Após E02/E04 e uma decisão registrada, comparar uma oferta apresentada a um grupo elegível
com o piloto preservado. Registrar: elegíveis expostos, oferta apresentada, compradores com
pagamento recebido, receita líquida, uso posterior, cancelamentos, custos associados e margem.
Interesse declarado não é comprador; clique ou resposta não é pagamento.

Não usar perda fictícia, paywall surpresa, recompensa ou retenção de dados para pressionar a
decisão. Próximo passo da equipe: responder a tabela acima e abrir uma tarefa própria para
checkout somente depois de provedor, condições e requisitos legais definidos.
