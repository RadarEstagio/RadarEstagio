...
Manter HTML/CSS/JS estático, Python e Supabase. Usuários recebem **até sete vagas** (decisão de Ian em
08/09/2026; cinco é só o padrão local do código). Não introduzir framework, dashboard, checkout, outra fonte,
