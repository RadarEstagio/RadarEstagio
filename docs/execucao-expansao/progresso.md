...
Estado em 08/09/2026: plano sincronizado com `40ed28c`. A fila ainda não foi executada;
C04 já possui implementação parcial anterior. As correções da auditoria estão na main.
Confirmar HEAD/main antes de iniciar; não reaplicar entregas existentes.
