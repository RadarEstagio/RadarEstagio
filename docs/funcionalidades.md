...
- **`descartes --amostra 30 --saida arquivo.json`**: Exportar uma amostra do que o pré-filtro descartou, com o motivo de cada corte, para as pessoas marcarem `descarte_correto`; consulta as fontes.
