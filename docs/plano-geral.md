...
> remoto e conferidas objeto a objeto; foram aplicadas fora do histórico de migrations e
> reconciliadas em 06/09, como registra a seção 9 do [guia](guia-publicacao-e-piloto.md); `telegram-webhook` (feedback de seis opções) e `ir`
